...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".cargo."0.61.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."3.1.15" { inherit profileName; };
      ...
      curl_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".curl-sys."0.4.54+curl-7.83.0" { inherit profileName; };
      ...
      git2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".git2."0.14.3" { inherit profileName; };
      ...
      libgit2_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libgit2-sys."0.13.3+1.4.2" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".clap."3.1.15" = overridableMkRustCrate (profileName: rec {
    name = "clap";
    version = "3.1.15";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "85a35a599b11c089a7f49105658d089b8f2cf0882993c17daf6de15285c2c35d"; };
    features = builtins.concatLists [
      [ "atty" ]
      [ "color" ]
      [ "default" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".curl-sys."0.4.54+curl-7.83.0" = overridableMkRustCrate (profileName: rec {
    name = "curl-sys";
    version = "0.4.54+curl-7.83.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "25debbc3365c3e7ee79e30918df5759e84dbd4485807a18829188abf1786ec4e"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "http2" ]
      [ "libnghttp2-sys" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".git2."0.14.3" = overridableMkRustCrate (profileName: rec {
    name = "git2";
    version = "0.14.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5e77a14ffc6ba4ad5188d6cf428894c4fcfda725326b37558f35bb677e712cec"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "https" ]
      [ "openssl-probe" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libgit2-sys."0.13.3+1.4.2" = overridableMkRustCrate (profileName: rec {
    name = "libgit2-sys";
    version = "0.13.3+1.4.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c24d36c3ac9b9996a2418d6bf428cc0bc5d1a814a84303fc60986088c5ed60de"; };
    features = builtins.concatLists [
      [ "https" ]
      [ "libssh2-sys" ]
      [ "openssl-sys" ]
